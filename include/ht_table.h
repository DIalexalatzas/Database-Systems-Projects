...
// Εκτυπώνει στην έξοδο τα στατιστικά στοιχεία ενός αρχείου πίνακα 
// κατακερματισμού με το δεδομένο όνομα αρχείου.
// Tα στατιστικά είναι τα εξής:
// 1. Το πόσα blocks έχει ένα αρχείο,
// 2. Το μέσο αριθμό των blocks που έχει κάθε bucket
// 3. Το ελάχιστο, το μέσο και το μέγιστο πλήθος εγγραφών που έχει κάθε bucket ενός αρχείου,
// 4. Το πλήθος των buckets που έχουν μπλοκ υπερχείλισης, και πόσα μπλοκ είναι αυτά για κάθε bucket.
